...
[![LinkedIn](https://img.shields.io/badge/Connect%20with%20me%20on-LinkedIn-blue.svg)](https://www.linkedin.com/in/paresh-kumar-rout-333246188/)
[![GitHub](https://img.shields.io/github/stars/AmanPathak-DevOps.svg?style=social)](https://github.com/Routparesh)
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/Routparesh/DevSecOps-Tetris-Project
   ```
...
This project is licensed under the Apache-2.0 license see the [LICENSE](http://www.apache.org/licenses/) file for details.# DevSecOps-Tetris-Project
